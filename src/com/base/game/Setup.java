...
public class Setup {
        ...
        public Setup() {
                Material material = new Material(new Texture("sky.jpg"), 10, 1, new Texture("sky.jpg"),
                                new Texture("sky.jpg"),
                                0, 0);
                ...
                skyFront.GetTransform().GetRot()
                                .Set(new Quaternion(new Vector3f(1, 0, 0), (float) Math.toRadians(-90)));
                ...
                skyRight.GetTransform().GetRot()
                                .Set(new Quaternion(new Vector3f(0, 0, 1), (float) Math.toRadians(-90)));
